  ...
  return (
    <div className="bg-white rounded-lg p-3">
        ...
        <div className="flex gap-1">
          <button
            ...
            className={`px-4 py-2 text-sm font-medium rounded transition-colors ${
              activeTab === "available" ? "bg-blue-100 text-blue-700" : "text-gray-600 hover:bg-gray-50"
            }`}
          >
            Available
          </button>
          <button
            ...
            className={`px-4 py-2 text-sm font-medium rounded transition-colors ${
              activeTab === "dismissed" ? "bg-blue-100 text-blue-700" : "text-gray-600 hover:bg-gray-50"
            }`}
          >
            Dismissed
          </button>
          ...
          {showSortDropdown && (
            <div className="absolute right-0 top-full mt-1 w-64 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
              <div className="p-3 space-y-2">
                ...
                >
                  <div className="font-medium text-sm">Sort by personalised</div>
                  <div className="text-xs text-gray-600">
                    Prioritise recommendations based on your recent ad account activity
                  </div>
                </div>
                <div
                ...
                >
                  <div className="font-medium text-sm">Sort by highest points</div>
                </div>
              </div>
            </div>
          )}
      ...
      <div className="text-center py-6 bg-gray-100 rounded-lg">
        ...
        <h4 className="text-lg font-medium text-gray-900 mb-2">No dismissed recommendations to review</h4>
        <p className="text-sm text-gray-600 max-w-md mx-auto">
          If you dismiss a recommendation, but change your mind later, you can review it again here as long as it's
          still available.
        </p>
      </div>
