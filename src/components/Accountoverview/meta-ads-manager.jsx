                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <div>
                                ...
                                <div className="text-xs text-gray-500">
                                  Ad account ID: 2422366124066184
                                </div>
                              </div>
                            </div>
                          </div>
        ...
        <div className="flex-1 p-6 overflow-auto">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div className="ml-auto text-right">
              <p className="text-sm text-gray-600">
                ...
                <span className="font-semibold">₹0.00 ₹</span> | 0% spent in
                learning phase{" "}
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
            ...
            <p className="text-gray-600 mb-6">
              Confirm the details below and you'll be ready to publish your
              first ad.
            </p>
            ...
            <div className="space-y-4">
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  This is the payment method that we'll keep on file for your ad
                  account. You won't be charged anything until your ads are up
                  and running.{" "}
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  A Page is required to run most ads. It will appear in your ad
                  as the brand or business that you're promoting. If you don't
                  have a Page, you can create one now and make changes at any
                  time.{" "}
                  <a href="#" className="text-blue-600 hover:underline">
                    Learn more
                  </a>
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Before you run ads, you need to add a verified phone number to
                  your ad account. We won't share this number publicly.
                </p>
                <button className="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors">
                  Add phone number
                </button>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  You applied all recommendations, which are proven to help
                  improve performance.
                </p>
              </div>
              <button className="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6 relative">
            ...
            <p className="text-gray-600 mb-4">
              Save time and stay optimised by automatically applying the most
              impactful performance recommendations.
            </p>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">
                Check again later to see ways to keep your score high.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg">
            ...
            <p className="text-sm text-gray-600">
              Email your account manager for personalised recommendations to
              help improve your strategy.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="w-1/3 bg-white shadow-xl">
            <div className="p-4 border-b border-gray-200">
              <div className="flex items-center justify-between mb-4">
                ...
                <h2 className="text-lg font-semibold text-gray-900">
                  Activity history for Account: Muhammad Bilal
                </h2>
                <div></div>
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-700">
                    This month: 1 Aug 2025 - 12 Aug 2025
                  </span>
                  <ChevronDown size={16} className="text-gray-400" />
                </div>
              </div>
            ...
            <div className="p-4">
              ...
              <div className="text-center py-12">
                ...
                <p className="text-sm text-gray-600">
                  Try again with a different date range. Bear in mind that new
                  activity can take up to 15 minutes to be shown in this table.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-end">
          <div className="w-96 bg-white shadow-xl">
            <div className="p-4 border-b border-gray-200">
              ...
              <p className="text-sm text-gray-600">
                These are profiles that you log in to business tools, such as
                Ads Manager. Select a profile to manage its assets. Save up to
                10 profiles.
              </p>
            </div>
            ...
            <div className="p-4">
              ...
              <div className="border-t border-gray-200 pt-4">
                ...
                <p className="text-xs text-gray-500 mt-2 px-3">
                  Adding a user profile will turn on saved profiles on this
                  device, so you can easily switch between profiles you use on
                  business tools. Don't do this if you're using a shared device.
                  You can remove profiles at any time.
                </p>
              </div>
