  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="relative">
        <button
          className="text-[#0A78BE] text-sm hover:underline focus:outline-none"
        ...
        {showTooltip && (
          <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 w-80 bg-white border border-gray-200 rounded-lg shadow-lg p-4 z-50">
            ...
            <div className="space-y-3 text-xs text-gray-700">
              <p>
                Your score of {points} means that you've applied all of our
                recommendations to optimise your campaigns, ad sets or ads, or
                that we have no recommendations for you at the moment.
              </p>
              <p>
                Your score changes as new recommendations become available, so
