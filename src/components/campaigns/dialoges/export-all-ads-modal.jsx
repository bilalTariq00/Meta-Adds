...
export default function ExportAllAdsModal({ isOpen, onClose }) {
  ...
  const handleExport = async () => {
    ...
    const csvContent =
      "data:text/csv;charset=utf-8,Campaign Name,Ad Set Name,Ad Name,Status\nSample Campaign,Sample Ad Set,Sample Ad,Active";
    const encodedUri = encodeURI(csvContent);
    const link = document.createElement("a");
    link.setAttribute("href", encodedUri);
    link.setAttribute("download", `ads_export.${selectedFormat}`);
        ...
        <div className="p-6 space-y-6">
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                />
                <label htmlFor="xlsx" className="text-sm text-gray-900">
                  Export as .xlsx
                </label>
              </div>
              ...
              <div className="flex items-center space-x-3">
                <input
                  ...
                  className="w-4 h-4 text-blue-600"
                />
                <label htmlFor="csv" className="text-sm text-gray-900">
                  Export as .csv
                </label>
              </div>
              ...
              <div className="flex items-center space-x-3">
                <input
                  ...
                  className="w-4 h-4 text-blue-600"
                />
                <label htmlFor="text" className="text-sm text-gray-900">
                  Export as text
                </label>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="flex items-center space-x-3">
              ...
              />
              <label htmlFor="remove-empty" className="text-sm text-gray-900">
