...
import { Search, Calendar, Home, Users, BarChart3, FileText, MessageSquare } from "lucide-react"

const SearchDialog = ({ isOpen, onClose }) => {
  if (!isOpen) return null

  const recentItems = [
    { icon: <Calendar size={20} />, label: "Events Manager", type: "Events Manager" },
    { icon: <Home size={20} />, label: "Ads Manager", type: "Ads Manager" },
    { icon: <Users size={20} />, label: "Audiences", type: "Audiences" },
    { icon: <BarChart3 size={20} />, label: "Ads Reporting", type: "Ads Reporting" },
  ...
  return (
    <div className="absolute inset-0 z-[9999] flex items-center justify-center max-h-screen overflow-y-auto">
      <div className="search-dialog bg-white rounded-lg shadow-xl w-96 max-h-96 overflow-hidden">
        ...
        <div className="p-4">
          <h4 className="text-sm font-medium text-gray-900 mb-3">Recently viewed</h4>
