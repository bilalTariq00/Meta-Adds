...
import { CreditCard, Activity, Building2, Sidebar } from "lucide-react";

export default function BillingSidebar({ activeView, onViewChange }) {
  ...
  const sidebarItems = [
    ...
    },
    {
      ...
      icon: CreditCard,
      active: activeView === "payment-methods"
    },
    {
      id: "payment-activity",
      label: "Payment activity",
      icon: Activity,
      active: activeView === "payment-activity"
    }
  ];
